(function ($) {
  ...
  $("#install-activate-button").on("click", function (e) {
    ...
    var activationData = {
      action: "woxstore_install_and_activate_plugins",
      nonce: woxstore_localize.nonce,
    };
    $.post(woxstore_localize.ajax_url, activationData, function (response) {
      ...
      if (match) {
        ...
        try {
          ...
          if (responseObj.success === true) {
            window.location.href = woxstore_localize.redirect_url;
          } else {
            console.log("Error!");
          }
        } catch (error) {
